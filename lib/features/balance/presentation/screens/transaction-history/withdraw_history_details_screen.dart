...
import "package:trading/features/balance/presentation/screens/transaction-history/widgets/withdraw_history_details_info.dart";
...
class WithdrawHistoryDetailsScreen extends StatefulWidget {
  ...
  final WithdrawHistoryModel withdrawHistory;
...
class _WithdrawHistoryDetailsScreenState extends State<WithdrawHistoryDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      title: "WITHDRAW_HISTORY_DETAILS".tr(context),
      showBackArrow: true,
        ...
        child: !showContent
            ...
            : Padding(
                ...
                child: Column(
                  ...
                  children: [
                    WithdrawInfoDetails(withdrawHistoryModel: widget.withdrawHistory, requestState: requestState),
                    ...
                    //         "${EndPoint.uploadDepositHistory}${widget.withdrawHistory.imageOne}",
                    ...
                    // Divider(color: Clr.f),
                    SizedBox(height: 10.h),
                    Txt.headlineMeduim("WITHDRAW_DATE".tr(context)),
                    Txt.bodyMeduim(widget.withdrawHistory.createdAt?.split(" ").first ?? "NOT_KNOWN".tr(context)),
                    SizedBox(height: 10.h),
                    ...
                    Visibility(
                        ...
                        child: Txt.bodyMeduim(widget.withdrawHistory.refuseReason ?? "NOT_KNOWN".tr(context))),
                  ],
                ),
              ),
      ),
